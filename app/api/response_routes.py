...
async def generate_response(request: GenerateResponseRequest):
    ...
    try:
        ...
        safety_result = safety_filter.validate(
            generated.generated_text, sender=request.sender, context={"category": "auto_reply"}
        )

        requires_approval = (
            request.require_approval or not safety_result.is_safe or generated.confidence < 0.7
        )
